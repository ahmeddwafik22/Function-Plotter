...
def test_2(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("2x")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test ==1
...
def test_4(app, qtbot):
    window = app
    window.function_widget.fun_textbox.setText("5")
    window.function_widget.x_min_textbox.setText("0")
...
def test_5(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("2x(2+)")
...
def test_7(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
...
def test_9(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("2.5(x+2).")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 1
...
def test_12(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("2")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 0
...
def test_14(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("2.x")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 0
...
def test_31(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("2y")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 1
...
def test_32(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("x2")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 0
...
def test_33(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("(2+x)8")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 0
...
def test_34(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("(2x+8")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 1
...
def test_36(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("[3x+3]2")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 0
...
def test_37(app, qtbot):
    window = app
    window.function_widget.flag_test=0
    window.function_widget.fun_textbox.setText("2x(4+8)")
    window.function_widget.x_min_textbox.setText("0")
    window.function_widget.x_max_textbox.setText("10")
    qtbot.mouseClick(window.function_widget.plot_button, Qt.LeftButton)
    assert window.function_widget.flag_test == 0
