...
class FunctionInputWidget(QWidget):
    ...
    def plot_function(self):
        ...
        if(len(function_text)==0):
            ...
            self.flag_test=1
            self.warning=QMessageBox.warning(self,"Warning", "please write your x_max")
            ...
            self.eval_system=eval_system.eval_service()
            self.valid,self.s=self.eval_system.preprocess_text(function_text)
